  ...
  themeConfig: {
    ...
    nav: [
      ...
      { text: 'UI Examples', link: '/ui-examples' },
      {
        text: 'v1.9.0',
        items: [
          { text: 'v1.9.0', link: 'https://github.com/chr0nzz/traefik-manager/releases/tag/v1.9.0' },
          { text: 'v1.8.0', link: 'https://github.com/chr0nzz/traefik-manager/releases/tag/v1.8.0' },
