...
async function openHttpProviderRouteDetail(idx) {
    ...
    const badge = `<span class="badge badge-muted ml-2" style="font-size:10px"><i class="ph-bold ph-link" style="font-size:9px"></i> http provider</span>`;
